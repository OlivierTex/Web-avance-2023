  ...
  const GridView = () => {
    ...
    return (
      <div className="w-4/5 mx-auto">
        ...
        <br />
        <div
          className={`grid grid-cols-1 ${imagesPerRow === 2 ? 'sm:grid-cols-2' : ''} ${
            imagesPerRow === 4 ? 'md:grid-cols-4' : ''
          } ${imagesPerRow === 6 ? 'grid-cols-6' : ''} gap-4 place-items-center`}
        >
    ...
    return (
      <div className="w-4/5 mx-auto">
        <div className="flex flex-wrap justify-center mt-8 gap-y-4">
          {videos.map((video) => (
            <div key={video.id} className={`${getClassName(imagesPerRow)} px-2 aspect-[1]`}>
        ...
        <form onSubmit={handleSearch} className="flex justify-center mb-2 dropdown rounded-md">
          ...
          <div className=" ml-4">
            <button
              ...
              className={`${
                imagesPerRow === 2 ? 'border border-gray-800 bg-gray-200' : 'bg-gray-100'
            ...
            <button
              ...
              className={`${
                imagesPerRow === 4 ? 'border border-gray-800 bg-gray-200' : 'bg-gray-100'
            ...
            <button
              ...
              className={`${
                imagesPerRow === 6 ? 'border border-gray-800 bg-gray-200' : 'bg-gray-100'
              } px-4 py-2 rounded-md ml-2`}
            >
      ...
      <div className="container mx-auto ">
        <div className="flex justify-center mb-4 ">
          <button
            ...
            className={`px-4 py-2 rounded-md ${viewMode === 'default' ? 'bg-gray-300' : ''}`}
          >
            Default View
          </button>
          <button
            onClick={() => setViewMode('grid')}
            className={`px-4 py-2 rounded-md ml-2 ${viewMode === 'grid' ? 'bg-gray-300' : ''}`}
          >
            Grid View
          </button>
        </div>
