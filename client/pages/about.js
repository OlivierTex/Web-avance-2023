      ...
      <div className={`bg-light dark:bg-dark`}>
        <h1 className="h1 mb-3">About</h1>
        {
          <div>
            ...
            <div className="dark:text-white m-4">
              ...
              <p className="mb-1">
                Bienvenue sur ImageHive, l'essence même de l'inspiration
                visuelle. Notre plateforme est conçue pour répondre à vos
                besoins créatifs, qu'il s'agisse de projets professionnels,
                artistiques ou simplement de la recherche d'une dose
                d'esthétisme au quotidien.
              </p>
              ...
              <p className="mb-1">
                ...
                monde moderne. Notre mission est de fournir une banque d'images
                et de vidéos exceptionnelle, accessible à tous.
              </p>
              ...
              <p>
                {" "}
                - Facilité de Téléchargement : Téléchargez facilement des
                contenus en haute résolution pour vos projets, que vous soyez un
              ...
              <p>
                Nous exprimons notre gratitude envers les artistes talentueux
                qui contribuent à la richesse de ImageHive. Leurs œuvres
                créatives enrichissent notre plateforme et inspirent la
                créativité dans le monde entier.
              </p>
              <p className="mb-3">
              ...
              <p className="mb-6">
                Ce projet a été réalisé dans le cadre scolaire en quatrième
                année d'ingénierie à ECE Paris.
              </p>
            </div>
          </div>
        }
        <div>
          ...
          <div className="dark:text-white m-4">
            ...
            <p className="mb-1">
              - Ne vendez pas de copies non modifiées d'une photo ou d'une
              vidéo, par exemple sous la forme d'une affiche, d'une impression
              ou d'un produit physique, sans les avoir modifiées au préalable.
            </p>
            <p className="mb-1">
              - Ne laissez pas entendre que des personnes ou des marques
              figurant sur les images approuvent votre produit.
            </p>
            <p className="mb-1">
